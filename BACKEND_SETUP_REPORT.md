...
| **Step 3** | **Private Storage Bucket** | **COMPLETED** | Materialized private `photos` bucket (12 MiB limit, restricted strictly to `image/jpeg`). |
...
- **Cleanup Secret**:
  ...
  ```
- **Public Page Origin**: `http://127.0.0.1:4173` *(default for local testing; change to production domain when deploying public site)*
